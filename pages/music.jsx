    ...
    <div className="mt-10 mx-auto max-w-6xl px-8 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 flex flex-row">
      <div className="sm:text-left">
        <h1 className="text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-5xl">
          ...
          <span className="block text-blue-500 xl:inline"> Music</span>
        </h1>
        <div className="mt-6 space-y-2 max-w-lg">
          ...
          <p className="text font-light">
            ...
            responsible and competitive musicians, bearing the Filipino values,
            culture and tradition, bringing pride and honor to the community and
            to God Almighty.
          </p>
        </div>
        <div className="mt-6 space-y-2 max-w-lg">
          ...
          <p className="text font-light">
            We aim to produce musicians who excel in their artistic expressions,
            realizing their skills, talents and potentials and maximizing their
            artistic abilities towards living as vital contributors to the
        ...
        <div className="mt-6 space-y-2 max-w-lg">
          ...
          <p className="text font-light">
            ...
            experiences and opportunities in the field of music. To uphold this
            commitment, this specialization shall:
          </p>
