    ...
    <div className="mt-10 mx-auto max-w-6xl px-8 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 flex flex-row">
      <div className="sm:text-center lg:text-left">
        <h1 className="text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-5xl">
          ...
          <span className="block text-blue-500 xl:inline"> Visual Arts</span>
        </h1>
        <div className="mt-6 space-y-2 max-w-lg">
          ...
          <p className="text font-light">
            ...
            responsible and competitive visual artists, bearing the Filipino
        ...
        <div className="mt-6 space-y-2 max-w-lg">
          ...
          <p className="text font-light">
            We aim to produce visual artists who excel in their artistic
      ...
      <Image
        layout="intrinsic"
        src="/programs-assets/visual-arts.svg"
        alt="Hero Image"
        width={650}
        height={650}
        className="pt-8"
